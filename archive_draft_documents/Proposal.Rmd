...
https://aidworkersecurity.org/incidents (for data on all attacks on aid workers since 1997)

* Humanitarian Outcomes data: https://www.humanitarianoutcomes.org/projects(for potentially relevant predictors, such as quantity of humanitarian actors in a given context)

* Uppsala Conflict dataset: https://ucdp.uu.se (for data on conflict intensity/number of civilian/non-civilian deaths)

* Humanitarian Data Exchange: https://data.humdata.org/  (for demographic and health data from conflict-affected countries)

* UNOCHA Attacks on Healthcare in Countries in Conflict datasets: https://data.humdata.org/dataset/shcchealthcare-dataset (for attacks on hospitals in conflcit settings)
...
Nov 14 - Framework for project finalized, including background research, as well as harvest and wrangle/tidy appropriate data
...
Dec 2 - Final draft complete - screencast completed and website finalized
