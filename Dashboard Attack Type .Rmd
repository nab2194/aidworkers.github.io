...
## Outcome 
#outcome = aidworker_df %>% 

## Year slider function 
years = aidworker_df %>% distinct(as.numeric(year)) %>% pull()

sliderInput(years,"Select Year(s)", 1997, 2020, value = "2019", step = NULL, round = FALSE, ticks = TRUE, animate = FALSE)
...
```{r Main page title }
ui<- fluidPage(
  titlePanel("Aid Worker Attacks by Means of Attack over Time")
)
```
...
h2("National Aid Worker Attacks")
