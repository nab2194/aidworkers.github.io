...
More thoughts for the morning...maybe geojson file contains lat/long data...should check. Can we somehow plot with lat long and aggregate by country? Although weird things were happening when trying to plot point data in leaflet earlier.
