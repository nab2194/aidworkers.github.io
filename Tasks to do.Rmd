...
* Make new df for Afghanistan data using the 'section 1' code: reading aidworker_df from web, and then filter by country

* Check numbers to make sure the aidworker_df filtered for afghanistan numbers of aidworkers affected (international & national) make sense?
