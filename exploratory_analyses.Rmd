...
Finally, this plot shows victims of the top 5 most dangerous countries over time. Context for the spike in attacks in Afghanistan in 2013 are discussed in the accompanying case study. 
...
plot_annotation(title = "Most Dangerous Countries: Attack Types and Contexts")
