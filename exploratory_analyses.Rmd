...
Finally, this plot shows victims of the top 5 most dangerous countries over time. Context for the spike in attacks in Afghanistan in 2013 is discussed in the accompanying case study. A rise in attacks in Syria corresponds to the start of the Syrian Civil War in 2011.  
...
plot_gender = 
  ...
  plot_ly(
    x = ~total_men, y = ~total_women, text = ~text_label, color = ~country,
          type = "scatter", mode = "markers",  colors = "viridis", marker = list(size = ~gap, opacity = 0.5))

layout(plot_gender, title = "Dangerous Country Gender Gap by Attack Type", xaxis = list(title = "Number of Women Attacked"), yaxis = list(title = "Number of Men Attacked"))
```
