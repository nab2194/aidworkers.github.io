...
## Location of Attack 
loc_attack = aidworker_df %>% distinct(location) %>% drop_na() %>% pull()
...
renderPlotly({ 
  ...
  plot_ly(x = ~year, y = ~total_victims, type = "scatter", mode = "lines", alpha = 0.5, color = ~attack_abr, text = ~text_label) %>% layout(xaxis = "Year", yaxis = "Number of Aid Workers Attacked")
})
...
renderPlotly({ 
  ...
  plot_ly(
    ...
    alpha = 0.5, color = ~attack_abr, text = ~text_label) %>% layout(xaxis = "Year", yaxis = "Number of National Staff Attacked")
})
...
renderPlotly({ 
  ...
  plot_ly(
    ...
    alpha = 0.5, color = ~attack_abr, text = ~text_label) %>% layout(xaxis = "Year", yaxis = "Number of International Staff Attacked")
})
