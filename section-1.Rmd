...
i.e. in ideal map, would have drop down to select year, and then would be able to hover over each country to see the total victims that year, total national, total international, total kidnappings, total shootings, and maybe total bombings (aggregate several attack types atove for this).... and would be AMAZING for that to be a heat map where colors darken for increased total victims as you change year.
