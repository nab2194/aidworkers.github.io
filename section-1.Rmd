...
At the moment I can only get markers for one country to appear. Managed to cluster data, need to explore this more however.

Attempt at `leaflet` map with points for attacks.
```{r map of attacks}
...
attack_map =
  ...
  popup = paste("Total Victims:", aidworker_df$total_victims, "<br>", "Means of Attack:", aidworker_df$means_of_attack, "<br>", "Year:", aidworker_df$year),
