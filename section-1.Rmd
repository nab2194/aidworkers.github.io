...
* Attack context 
* Location 
* Country (** note to everyone: should we just do the top 10 most dangerous countries? )
...
# aidworker_df %>% 
 ...
 # select(gender_male, gender_female, year, location, attack_context, actor_type, country) %>% 
 # cor() %>% 
